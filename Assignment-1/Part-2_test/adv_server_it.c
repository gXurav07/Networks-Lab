...
float numStack[2];		// stack for operands or number
...
int main(){
	...
	while(1){
		...
		while(1) {
			...
			int receive_count=0; 	// stores the count of parts of an expression received 
			while(1){
